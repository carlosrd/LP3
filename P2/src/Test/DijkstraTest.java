...
public class DijkstraTest extends TestCase {
	...
	public void setUp() {
		...
		dij1 = new Dijkstra(g1);
		dij2 = new Dijkstra(g2);
		dij3 = new Dijkstra(g3);
	...
	public void testAAlgoritmo(){
		...
		Assert.assertEquals(expected,(Collection<Arista>)dij1.calculaCaminoMinimo(v1,v4));
	}
	...
	public void testBAlgoritmo(){
		...
		aux.add(a10);
		Collection<Arista> expected = aux;
		Assert.assertEquals(expected,(Collection<Arista>)dij2.calculaCaminoMinimo(v7,v10));
	}
	...
	public void testCAlgoritmo(){
		...
		aux.add(a12);
		Collection<Arista> expected = aux;
		Assert.assertEquals(expected,(Collection<Arista>)dij3.calculaCaminoMinimo(v13,v15));
	}
}
